...
This directory contains source files for the Zulu language morphology
...
-   <http://giellatekno.uit.no/zuldoc/index.html>
-   <https://giellalt.uit.no/tools/docu-zul-manual.html>
-   <https://giellalt.uit.no/index.html>

Requirements
------------

In order to compile and use Zulu language morphology and dictionaries,
you need:
...
The Zulu language sources can be acquired using [giella SVN
